...
/*
   ...
   EXPRESS TOKEN_OR IMPLIED, INCLUDING BUT TOKEN_NOT LIMITED TO THE WARRANTIES OF
   MERCHANTABILITY, FITNESS TOKEN_FOR A PARTICULAR PURPOSE TOKEN_AND NONINFRINGEMENT.
   IN NO EVENT SHALL THE AUTHORS BE LIABLE TOKEN_FOR ANY CLAIM, DAMAGES TOKEN_OR
   OTHER LIABILITY, WHETHER IN AN ACTION OF CONTRACT, TORT TOKEN_OR OTHERWISE,
   ARISING FROM, OUT OF TOKEN_OR IN CONNECTION WITH THE SOFTWARE TOKEN_OR THE USE TOKEN_OR
